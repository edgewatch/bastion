...
Release assets are accepted with content-types `application/vnd.debian.binary-package`, `application/x-debian-package`, or `application/octet-stream` (manual `gh` uploads often use the latter two).
